...
O projeto representa uma aplicação onde um usuário pode visualizar um catálogo de cervejas artesanais. Possui páginas com as seguintes funcionalidades:
</p><br>

- Register - onde o usuário pode fazer o seu cadastro;
- Login - logar, gerando um token, para acesso ao seu perfil;
- Dashboard- onde o usuário tem acesso ao catálogo das cervejas. Também possui um botão de ver mais, aonde abre-se um modal contendo as informações da cerveja selecionada e um filtragem de cervejas por IBU e teor alcólico.

<h2 font-family="pattaya">Requisitos técnicos:</h2><br>

- a aplicação utiliza api rodando localmente na máquina do usuário para fazer login e cadastro nesta aplicação.
- Também utiliza a <a href="https://punkapi.com/" font-family="robotto" font-size="16px">Api externa</a>, para renderizar as cervejas do catálogo.
...
- máscara para número de telefone, cpf e data de nascimento, utilizando InputMask (react-input-mask)
